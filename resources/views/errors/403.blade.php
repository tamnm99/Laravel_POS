...
<head>
    ...
    <title>TEAM 3 | Không đủ quyền</title>
...
<div class="scene">
    ...
    <div class="text">
        ...
        <span class="msg">Bạn không có quyền truy cập trang web này.</span>
        <span class="support">

      <a href="#">Liên Hệ Quản Trị viên để biết thêm thông tin chi tiết</a>
    </span>
    </div>
    <div class="lock"></div>
</div>
