...
@section('title', 'Thêm Mới Hóa Đơn Bán Hàng')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Thêm Mới Hóa Đơn Bán Hàng</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Hóa Đơn Bán Hàng Mới</h3>
                            ...
                            <div class="row">
                                <div class="col-md-2 offset-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="total_product_fee"
                                               name="total_product_fee" value="0" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                        ...
                                        <select name="tax_rate" id="tax_rate" class="form-control">
                                            @foreach($taxes as $tax)
                                                <option value="{{$tax->rate}}"
                                                        @if($tax->rate == 0) selected @endif>{{$tax->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-2 offset-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="tax_fee" name="tax_fee" value="0"
                                               readonly>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function () {
            ...
            $('#insert_purchase_form').on('submit', function (event) {
                ...
                if ((has_error == false)) {
                    ...
                    $.ajax({
                        url: "{{route('admin.saleInvoices.store')}}",
                        method: "POST",
                        dataType: "JSON",
                        data: {
                            form_data: form_data,
                    ...
                    toastr.success('Tạo Mới Hóa Đơn Bán Hàng thành công', 'Thành Công!', {timeOut: 4000});
