...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Trang Đầu",sLast:"Trang Cuối",sNext:"Trang Tiếp",sPrevious:"Trang Trước"},sEmptyTable:"Chưa có dữ liệu tại bảng này",sInfo:"Hiển Thị _START_ tới _END_ của _TOTAL_ dữ liệu",sInfoEmpty:"Hiển Thị 0 tới 0 của 0 dữ liệu",
sInfoFiltered:"(Lọc từ _MAX_ tổng số dữ liệu)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển Thị _MENU_ dữ liệu",sLoadingRecords:"Đang Tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm Kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy Dữ Liệu trùng khớp"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
